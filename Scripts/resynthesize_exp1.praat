...
form Resynthesize Continuum
	...
	text fromDir ..\05_NudgedRecordings\ConstantScaling_80
	comment Directory of TextGrid files
	text tgFromDir ..\05_NudgedRecordings\ConstantScaling_80\TextGrids
	comment Directory to save output sound files
	text outDir ..\06_ResynthesizedRecordings
	comment Directory to save output PitchTier files
	text ptDir ..\06_ResynthesizedRecordings\PitchTiers
	comment Directory to copy TextGrid files into
	text tgToDir ..\06_ResynthesizedRecordings\TextGrids
	...
	positive nSteps 5
	comment Smallest ERB differential
	real lowErb -0.25
	comment Highest ERB differential
	real highErb 2
